...
<table width="100%">
	...
	<tbody>
		<tr>
			<th span="row"><a href="https://github.com/JoshuaKGoldberg/Old-Deleted-FullScreenMario">FullScreenMario</a></th>
			<td>An HTML5 remake of the original Super Mario Brothers - expanded for wide screens.</td>
			<td>Creator</td>
			<td><img alt="Stars: FullScreenMario" src="https://img.shields.io/github/stars/JoshuaKGoldberg/Old-Deleted-FullScreenMario" /></td>
		</tr>
		<tr>
			<th span="row"><a href="https://github.com/FullScreenShenanigans/FullScreenPokemon">FullScreenPokemon</a></th>
			<td>A free HTML5 remake of the original Pokemon, expanded for modern browsing.</td>
			<td>Creator & maintainer</td>
...
> 💙 This package is templated with [create-typescript-app](https://github.com/JoshuaKGoldberg/create-typescript-app).
